...
\begin{definition}\index{concave up}\index{concave down}
	A function $f$ is \emph{concave up} in an interval $I$ if the graph of $f$ lies above its tangent lines.
	$f$ is \emph{concave down} in an interval $I$ if the graph of $f$ lies below its tangent lines.
\end{definition}
\begin{example}
