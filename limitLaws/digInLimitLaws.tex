...
There are several other continuous functions.  Some that you are familiar with are mentioned in the following statement.
We will study these functions in more depth later.

\begin{theorem}[Continuity of Other Functions]
	The trigonometric functions $\sin x$ and $\cos x$ and exponential functions $a^x$
	are continuous everywhere.  The other trigonometric functions are continuous in
	their domain.
\end{theorem}
