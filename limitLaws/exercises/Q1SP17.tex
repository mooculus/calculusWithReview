...
\begin{exercise}
	...
	due to \wordChoice{\choice{limit laws}\choice{continuity}\choice{of the difference law}\choice{quotient law}\choice[correct]{the Squeeze Theorem}}.

		\begin{exercise}
			Now consider the quotient $\frac{h(x)}{g(x)}$. The form of the limit $\lim_{x\to 1^+}\frac{h(x)}{g(x)}$ is of the form 
			\wordChoice{\choice{nonzero over zero} \choice[correct]{zero over zero}}.
