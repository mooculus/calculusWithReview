...
\begin{example} 
  ...
  \begin{align*}
    h(0) &= f(0) - g(0) \\
    &= (\answer[given]{0})^2\cdot \sqrt{(\answer[given]{0})} - 2\cdot(\answer[given]{0}+1) \cdot \cos\left(\sqrt[3]{(\answer[given]{0})} \right)\\
    &= \answer[given]{-2}.
  \end{align*}
  and in a similar fashion
   \begin{align*}
    h\left(\left( \frac{\pi}{2}\right)^3\right) &= f\left(\left( \frac{\pi}{2}\right)^3\right) - g\left(\left( \frac{\pi}{2}\right)^3\right) \\
         &= \left( \left( \frac{\pi}{2}\right)^3\right)^2\cdot \sqrt{\left( \frac{\pi}{2}\right)^3} \\ 
