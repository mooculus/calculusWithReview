...
Use the graph of $y = f(x)$ given below
...
\end{tikzpicture}
\end{image}
	How many $x$-intercepts does the function $f$ have?
	\answer{3}

	\begin{exercise}
		List the $x$-intercepts from left to right.  \[\answer{-4},\, \answer{-1} ,\, and\, \answer{1}\]
	\end{exercise}
\end{exercise}
\end{document}
