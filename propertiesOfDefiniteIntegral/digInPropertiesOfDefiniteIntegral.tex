...
%%% In mooculus/calculus1, this is a section of definiteIntegral
\input{../preamble.tex}
...
\title[Dig-In:]{Properties of the definite integral}
...
The strong relationship between definite integrals and areas gives several properties that we can use
