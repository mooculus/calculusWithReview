...
% - removed for 1140 -BWR
%The slope of the tangent line to $f$ at the point $\left(4,-2\right)$ is $\answer{-1}$.\\
...
\choice{The one-sided limit does not exist because $f$ is not defined the same to the left and right of 2.}
\choice{The one-sided limit does not exist because $f(2)$ is very different from the values of $f$ near 2.}
\end{multipleChoice}
