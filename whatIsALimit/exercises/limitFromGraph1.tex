...
\begin{selectAll}
	...
	\choice[correct]{The function is one-to-one.}
	\choice{The function is NOT one-to-one.}
	\choice{The graph passes the Vertical Line Test.}
	\choice{The graph fails the Vertical Line Test.}
	\choice[correct]{The graph passes the Horizontal Line Test.}
	\choice{The graph fails the Horizontal Line Test.}
\end{selectAll}
...
\choice{The one-sided limit does not exist because $f(3)$ does not exist.}
\choice{The one-sided limit does not exist because $f(3)$ is not close to the values of $f$ near 3.}
\end{multipleChoice}
