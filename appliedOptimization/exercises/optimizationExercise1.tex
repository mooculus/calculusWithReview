		...
		\begin{exercise}
			...
			\begin{exercise}
				...
				\begin{exercise}
					...
					\wordChoice{\choice{positive}\choice[correct]{negative}}, and for $x>45.8$, $C'(x)$ is \wordChoice{\choice[correct]{positive}\choice{negative}}.
					\begin{exercise}
						  Then by the \wordChoice{\choice{increasing/decreasing test} \choice{extreme value theorem} \choice{mean value theorem}
						  \choice[correct]{first derivative test} \choice{second derivative test}}, $C$ has  
						  \wordChoice{\choice{an inflection point}\choice{a local maximum} \choice[correct]{a local minimum}} at $x=45.8$.
						  \begin{exercise}
