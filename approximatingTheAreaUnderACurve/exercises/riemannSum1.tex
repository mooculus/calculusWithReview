...
The image depicts a \wordChoice{\choice{Left}\choice[correct]{Right}\choice{Midpoint}} Riemann sum with $n=\answer{12}$ subintervals.

\begin{align*}
x_6^* &= \answer{3}\\
f(x_6^*) &= \answer{27}\\
\Delta x &= \answer{\frac{1}{2}}\\
\text{Riemann Sum} &= \answer{\frac{539}{4}}
% Not ready for sigma notation here
\end{align*}
