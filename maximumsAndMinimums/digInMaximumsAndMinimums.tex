	...
	\begin{axis}[
       ...
       \addplot [ very thick, penColor, smooth] plot coordinates {(0.75,0) (1.25,0)}; 
          ...
          \node at (axis cs:2.2,5/2) [anchor=west] {\color{penColor}$f$};  
              \node at (axis cs:0.52,-3) [anchor=west] {\color{penColor}$f(x)$};  
...
$(-\infty,-\frac{\sqrt{3}}{3})$, 
$(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$, and 
$(\frac{\sqrt{3}}{3},\infty)$, because these intervals do not contain 
any zeros of $f'(x)$.
 
\begin{question}
Select the correct  statement about the sign of $f'(x)$ on the 
intervals $(-\infty,-\frac{\sqrt{3}}{3})$ and $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. \\ 
  \begin{multipleChoice}
    \choice{$f'(x)>0$ on $(-\infty,-\frac{\sqrt{3}}{3})$ and $f'(x)>0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
      \choice[correct]{$f'(x)>0$ on $x$ in $(-\infty,-\frac{\sqrt{3}}{3})$ and $f'(x)<0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
        \choice{$f'(x)<0$ on $(-\infty,-\frac{\sqrt{3}}{3})$ and $f'(x)>0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
          \choice{$f'(x)<0$ on $(-\infty,-\frac{\sqrt{3}}{3})$ and $f'(x)<0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$}
            \end{multipleChoice}
  \end{question}
...
At the critical point where $x=-\frac{\sqrt{3}}{3}$, the function $f$ has  \\
  ...
  \begin{multipleChoice}
    \choice{no local extremum, because $f$ is increasing on $(-\infty,-\frac{\sqrt{3}}{3})$ and increasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
      \choice[correct]{a local maximum, because $f$ is increasing on $(-\infty,-\frac{\sqrt{3}}{3})$ and decreasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
      \choice{a local minimum, because $f$ is decreasing on $(-\infty,-\frac{\sqrt{3}}{3})$ and increasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }
         \choice{no local extremum, because $f$ is decreasing on $(-\infty,-\frac{\sqrt{3}}{3})$ and decreasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$. }  \end{multipleChoice}
  \end{question}
  \begin{question}
Select the correct  statement about the sign of $f'(x)$ on the intervals  $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and  $(\frac{\sqrt{3}}{3},\infty)$. \\
 
  \begin{multipleChoice}
    \choice{$f'(x)>0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$  and $f'(x)>0$ on $(\frac{\sqrt{3}}{3},\infty)$.}
    \choice{$f'(x)>0$ on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and $f'(x)<0$ on $(\frac{\sqrt{3}}{3},\infty)$.}
       \choice[correct]{$f'(x)<0$ on   $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$  and $f'(x)>0$ on $(\frac{\sqrt{3}}{3},\infty)$.}
         \choice{$f'(x)<0$ on  $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$  and $f'(x)<0$ on $(\frac{\sqrt{3}}{3},\infty)$.}
  \end{multipleChoice}
  \end{question}
...
At the critical point where $x=\frac{\sqrt{3}}{3}$, the function $f$ has  \\
  ...
  \begin{multipleChoice}
    \choice{no local extremum, because $f$ is increasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and increasing on $(\frac{\sqrt{3}}{3},\infty)$. }
       \choice{a local maximum, because $f$ is increasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and decreasing on $(\frac{\sqrt{3}}{3},\infty)$. }
      \choice[correct]{a local minimum, because $f$ is decreasing on $(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and increasing on $(\frac{\sqrt{3}}{3},\infty)$. }
        \choice{no local extremum, because $f$ is decreasing on$(-\frac{\sqrt{3}}{3},\frac{\sqrt{3}}{3})$ and decreasing on $(\frac{\sqrt{3}}{3},\infty)$. }
      \end{multipleChoice}
  \end{question}
...
\begin{definition}\index{inflection point}
	...
	or down to up at $x=a$, then $f$ has an \dfn{inflection point} at $x=a$.
\end{definition}
